...
import { ContactChannel, ContactData } from "@/types/contact";
...
export default function AdminContactForm() {
  ...
  const handleStyleUpdate = (field: keyof ContactData, style: ElementStyle) => {
    if (!data) return;
        ...
        <section className="space-y-8 max-w-4xl">
          ...
          <StyleController
            ...
            onChange={(style: ElementStyle) =>
              handleStyleUpdate("titleStyle", style)
            }
          />
          <div className="space-y-3">
            <label
          ...
          <StyleController
            ...
            onChange={(style: ElementStyle) =>
              handleStyleUpdate("descriptionStyle", style)
            }
          />
        </section>
            ...
            <div className="space-y-3">
              ...
              <p className="text-[10px] text-white/30 font-medium">
                * 구글 지도에서 &quot;지도 퍼가기&quot;의 &lt;iframe&gt; 태그 내{" "}
                <span className="text-white/60">src=&quot;...&quot;</span> 안의
                주소만 복사해서 붙여넣으세요.
              </p>
            </div>
          </div>
